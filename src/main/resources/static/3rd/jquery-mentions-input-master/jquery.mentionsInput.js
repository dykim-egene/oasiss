 ...
 * 
 * 20200715 한글키 입력 지원이 안되는 문제로 한글키 입력으로 검색할 수 잇도록 수정함.
 * 
 */
    ...
    var MentionsInput = function (settings) {
        ...
        function initTextarea() {
            ...
            elmInputBox.bind('input', function(e){
                ...
                // trigger 문자 위치 확인
                var triggerIndex = inputValue.lastIndexOf(settings.triggerChar, endIndex);

                if (triggerIndex > -1) {
                    inputBuffer = inputValue.substring(triggerIndex, endIndex).split('');
                }
            });
        ...
        function resetInput(currentVal) {
            ...
            if (elmInputBox[0]) {
                // ie11 미지원으로 jquery 로 변경
                //elmInputBox[0].dispatchEvent(new Event('change'));
                $(elmInputBox[0]).trigger('change');
            }
            updateValues();
        }
        // Public methods
