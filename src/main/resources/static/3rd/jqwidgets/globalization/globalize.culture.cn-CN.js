var getLocalization = function (culture) {
    var localization = {
		...
		decimalseparator: '.',
		thousandsseparator: ',',
		pagergotopagestring: "页面移动:",
		pagershowrowsstring: "序数:",
		pagerrangestring: " 的 ",
		pagerpreviousbuttonstring: "以前",
		pagernextbuttonstring: "下次",
		pagerfirstbuttonstring: "先",
		pagerlastbuttonstring: "最后",
		groupsheaderstring: "Drag a column and drop it here to group by that column",
		sortascendingstring: "盘次差",
		sortdescendingstring: "降幂顺序",
		sortremovestring: "排列排序",
