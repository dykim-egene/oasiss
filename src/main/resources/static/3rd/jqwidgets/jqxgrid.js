    ...
    $.extend($.jqx._jqxGrid.prototype, {
        ...
        _getrowdetails: function (index) {
            ...
            if (this.rowdetailstemplate) {
                if(typeof this.rowdetailstemplate==="function"){
                    var e=this.rowdetailstemplate(index);
                    if(e.rowdetailshidden===undefined){e.rowdetailshidden=true}
                    if(e.rowdetailsheight===undefined){e.rowdetailsheight=200}
                    if(e.rowdetails===undefined){e.rowdetails="<div></div>"}
                    return e
                }
        ...
        _setrowdetailsvisibility: function (index, details, hidden) {
            if (this.rowdetailstemplate) {
                ...
                if (!this.details[index]) {
                    var g=typeof this.rowdetailstemplate==="function"?this.rowdetailstemplate(index):this.rowdetailstemplate;
                    if(undefined===g.rowdetailshidden){g.rowdetailshidden=true}
                    if(undefined===g.rowdetailsheight){g.rowdetailsheight=200}
                    if(undefined===g.rowdetails){g.rowdetails="<div></div>"}

                    this.details[index]={rowdetailshidden:g.rowdetailshidden,rowdetailsheight:g.rowdetailsheight,rowdetails:g.rowdetails};
        ...
        _loadrows: function () {
            ...
            for (var i = 0; i < pagesize; i++) {
                ...
                if (this.rowdetailstemplate) {
                    var w=typeof this.rowdetailstemplate==="function"?this.rowdetailstemplate(row.boundindex):this.rowdetailstemplate;
                    row.rowdetails=w.rowdetails;
                    row.rowdetailsheight=w.rowdetailsheight;
                    row.rowdetailshidden=w.rowdetailshidden;
                    if(row.rowdetailshidden===undefined){row.rowdetailshidden=true}
                    if(row.rowdetailsheight===undefined){row.rowdetailsheight=200}
                    if(row.rowdetails===undefined){row.rowdetails="<div></div>"}
                        ...
                        if (this.rowdetails) {
                            if (this.rowdetailstemplate) {
                                ...
                                if(!rowinfo.details){
                                    ...
                                    if(v.rowdetailshidden===undefined){v.rowdetailshidden=true}
                                    if(v.rowdetailsheight===undefined){v.rowdetailsheight=200}
                                    if(v.rowdetails===undefined){v.rowdetails="<div></div>"}
                                    rowinfo.details=v
                                }
                            }
        ...
        _rendervisualrows: function () {
            ...
            // 크롬에서 스크롤 하단 내용이 짤리는 현상 수정 https://www.jqwidgets.com/community/topic/jqxgrid-selection-problem/#post-113349
